...
##################################
wificonnectmon_target=wificonnectmon
wificonnectmon_sources=wificonnectmon.c utils.c led.c
wificonnectmon_cc=$(CC)
wificonnectmon_ld=$(LD)
wificonnectmon_cflags=$(CFLAGS)
wificonnectmon_ldflags=$(LDFLAGS)

build_targets=wificonnectmon
